...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ****FOR REFERENCE ONLY****
        ...
        Members member1 = new Members("Jai", "Vang", 0, 0, 1, "Credit Card", "regular");
        Members member2 = new Members("Bill", "Gates", 0, 0, 2, "Debit Card", "regular");        
        ...
        ****FOR REFERENCE ONLY****
        public PremiumMembers(String firstName, String lastName, int totalMoneySpent, int itemsPurchased, int memberID, 
            String methodOfPayment, String membershipType boolean hasPreiumMembership, boolean paidFeeOnTime, int monthlyFee)
        ...
        PremiumMembers premiumMember2 = new PremiumMembers("Steph", "Curry", 0, 0, 2, "Debit Card", "premium", true, false, 51);
        PremiumMembers premiumMember3 = new PremiumMembers("Tom", "Hank", 0, 0, 3, "Credit Card", "premium", true, false, 52);
        ...
        //premiumMemberList.add(new PremiumMembers("Tom", "Hank", 0, 0, 3, "Credit", "premium", true, false, 52));
            ...
            switch (numberSelected) {  //start of second swtich
                ...
                case 1: // 1. Complete a purchase
                    ...
                    switch(numberSelected2){
                        ...
                        //calcuates the customer's total amount of purchase by multiplying the number of books, Dvds, and CDs with by it's price
                        pricingAndPurchaseInstance.calculatingTheCustomersTotal(numberOfBooksPurchased, numberOfDVDsPurchased,
                                                                              numberOfCDsPurchased);
                        //calcuates total items customer puchased
                        int totalItemPurchased = numberOfBooksPurchased + numberOfDVDsPurchased + numberOfCDsPurchased;
                        ...
                        if (IDEntered >= 1 && IDEntered <= 10) { 
                            ...
                            for (Members member: memberList) {          
                                ...
                                if(member.getMemberID() == IDEntered) {   
                                    ...
                                    int memberPreviousAndCurrentSpendingAddTogether = member.getHowMuchMoneyMemberHadSpent()
                                                                                 + totalSpending;
                                    ...
                                    int memberPreviousAndCurrentItemsPurchaseAddTogether = member.getTotalItemsPurchased() + totalItemPurchased;
                        ...
                        {
                            System.out.println("Invaild input. Exiting to main menu.");             //if input is not 1, 2, or 3. 
                        }
                        ...
                        bookStoreInventoryInstance.deductionOfBooksFromInventory(numberOfBooksPurchased);   //deducts books from inventory
                        bookStoreInventoryInstance.deductionOfDVDsFromInventory(numberOfDVDsPurchased);    //deduects DVDs from inventory
                        bookStoreInventoryInstance.deductionOfCDsFromInventory(numberOfCDsPurchased);     //deducts Cds from inventory                            
                        ...
                        //calcuates the customer's total amount of purchase by multiplying the number of books, Dvds, and CDs with by it's price
                        pricingAndPurchaseInstance.calculatingTheCustomersTotal(numberOfBooksPurchased2, numberOfDVDsPurchased2,
                                                                              numberOfCDsPurchased2);
                        //calcuates total items customer puchased
                        int totalItemPurchased2 = numberOfBooksPurchased2 + numberOfDVDsPurchased2 + numberOfCDsPurchased2;
                        ...
                        if (IDEntered2 >= 1 && IDEntered2 <= 10) {
                           //Loop through arrayList memberList
                            for (PremiumMembers premiumMember: premiumMemberList){
                                //If a premium member in the list has an ID number equals to user IDInput(1 through 10)
                                if(premiumMember.getMemberID() == IDEntered2) {     
                                    //add previous spending with current spending
                                    int memberPreviousAndCurrentSpendingAddTogether = premiumMember.getHowMuchMoneyMemberHadSpent()
                                                                                 + totalSpending2;
                                    ...
                                    int memberPrviousAndCurrentItemsPurchaseAddTogether = premiumMember.getTotalItemsPurchased() 
                                            + totalItemPurchased2;
                        ...
                        System.out.println();
                        //At the end, print statment telling user order is in, and thank you for your purchased. 
                        System.out.println("Your order is in. Thank you for your purchaee!");


                        //Deducts items purchase from inventory
                        bookStoreInventoryInstance.deductionOfBooksFromInventory(numberOfBooksPurchased2);   //deducts books from inventory
                        bookStoreInventoryInstance.deductionOfDVDsFromInventory(numberOfDVDsPurchased2);    //deduects DVDs from inventory
                        bookStoreInventoryInstance.deductionOfCDsFromInventory(numberOfCDsPurchased2);     //deducts Cds from inventory                             
                                ...
                                for (Members member: memberList) {      
                                   //If a member in the list ID number equals to user IDInput(1 through 10)       
                                    if(member.getMemberID() == IDInput) {    
                                        ...
                                        System.out.println(member.getFirstNameOfMember() + " " + member.getLastNameOfMemeber() + 
                                                " has " +member.getMembershipType()+ " membership");
                                        
                                        System.out.println(member.getFirstNameOfMember() + " " + member.getLastNameOfMemeber() + 
                                                " total spending is $" + member.getHowMuchMoneyMemberHadSpent());
                                   ...
                                   //If a member in the list ID number equals to user IDInput(1 through 10)       
                                    if(premiumMember.getMemberID() == IDInput2){
                                        ...
                                        if(premiumMember.isAPremiumMember() == true) {
                                            ...
                                            //print member first and last name and state that member has premium membership
                                            System.out.println(premiumMember.getFirstNameOfMember() + " " + premiumMember.getLastNameOfMemeber() + " has " +premiumMember.getMembershipType()+ " membership.");
                                        }
                                        else {
                                            
                                            //If not true, print that member is not premium member
                                            System.out.println(premiumMember.getFirstNameOfMember() + " " +premiumMember.getLastNameOfMemeber() + " does not have Premium Membership" );
                                        }  
                                        
                                        //These prints also in loop
                                        System.out.println(premiumMember.getFirstNameOfMember() + " " + premiumMember.getLastNameOfMemeber() + " total spending is $" + premiumMember.getHowMuchMoneyMemberHadSpent());
                                        System.out.println(premiumMember.getFirstNameOfMember() + " " + premiumMember.getLastNameOfMemeber() + " purchased " + premiumMember.getTotalItemsPurchased()+ " items");
                                        System.out.println(premiumMember.getFirstNameOfMember() + " " + premiumMember.getLastNameOfMemeber() + " ID number is " + premiumMember.getMemberID());
                                        System.out.println(premiumMember.getFirstNameOfMember() + " " + premiumMember.getLastNameOfMemeber() +  " method of payment is " +premiumMember.getMemberPaymentMethod());
                                        
                                        //if premium member has not pay fee on time
                                        if (premiumMember.isFeePaidOnTime() != true)   //if the fee due for new member is NOT TRUE
                                        {           
                                            //print that fee is due and needs to be pay ASAP
                                            System.out.println(premiumMember.getFirstNameOfMember() + " " + premiumMember.getLastNameOfMemeber() + " fee is due. Needs to pay ASAP"); //this prints
                                        } 
                                        else 
                                        {
                                            //If true, print that premium member had pay fee.
                                            System.out.println(premiumMember.getFirstNameOfMember() + " " + premiumMember.getLastNameOfMemeber() + " has paid fee.");                //otherwise, this prints
                                        }

                                        System.out.println(premiumMember.getFirstNameOfMember() + " " + premiumMember.getLastNameOfMemeber() + 
                ...
                case 3: //compare items
                    ...
                    switch (numberEntered){
                        case 1: //Compare the price of book with price of CD
                            ...
                            System.out.println("Will return '1' if the price of book is greater than the price of CD. ");
                            ...
                            int compareItem = bookInstance.compareTo(cd1);  //can use cd1, cd2 or cd3 in parameter      
                            switch (compareItem) {
                                case 1 -> System.out.println("Return: '" +compareItem + "' because the price of book is greater than price of CD");
                                case -1 -> System.out.println("Return: '" +compareItem + "' because the price of book is less than price of CD");
                                default -> System.out.println("Return: '" +compareItem + "' because the price of book and CD are equal.");
                            }
                        ...
                        case 2: //Compare the price of book with price of DVD
                            ...
                            System.out.println("Will return '1' if the price of book is greater than the price of DVD. ");
                            ...
                            switch (compareItem2){
                                case 1 -> System.out.println("Return: '" +compareItem2 + "' because the price of book is greater than price of DVD");
                                case -1 -> System.out.println("Return: '" +compareItem2 + "' because the price of book is less than price of DVD");
                                default -> System.out.println("Return: '" +compareItem2 + "' because the price of book and DVD are equal.");
                            }
                        ...
                        case 3: //Compare the price of CD with the price of DVD
                            ...
                            switch (compareItem3){
                                case 1 -> System.out.println("Return: '" +compareItem3 + "' because the price of CD is greater than price of DVD");
                                case -1 -> System.out.println("Return: '" +compareItem3 + "' because the price of CD is less than price of DVD");
                                default -> System.out.println("Return: '" +compareItem3 + "' because the price of CD and DVD are equal.");
                            }
                        ...
                        case 4: //Compare the price of CD to the price of Book
                            ...
                            System.out.println("Will return '1' if the price of CD is greater than the price of Book. ");
                            ...
                            int compareItem4 = cdsInstance.compareTo(book2); //Can use book1, book2 or book3 in parameter
                            switch (compareItem4){
                                case 1 -> System.out.println("Return: '" +compareItem4 + "' because the price of CD is greater than price of Book");
                                case -1 -> System.out.println("Return: '" +compareItem4 + "' because the price of CD is less than price of BOok");
                                default -> System.out.println("Return: '" +compareItem4 + "' because the price of CD and Book are equal.");
                            }                            
                        ...
                        case 5: //Compare the price of DVD to the price of Book
                            ...
                            System.out.println("Will return '1' if the price of DVD is greater than the price of Book. ");
                            ...
                            int compareItem5 = dvdsInstance.compareTo(book3); //Can use book1, book2 or book3 in parameter
                            switch (compareItem5){
                                case 1 -> System.out.println("Return: '" +compareItem5 + "' because the price of DVD is greater than price of Book");
                                case -1 -> System.out.println("Return: '" +compareItem5 + "' because the price of DVD is less than price of BOok");
                                default -> System.out.println("Return: '" +compareItem5 + "' because the price of DVD and Book are equal.");
                            }                            
                        ...
                        case 6: //Compare the price of DVD to the price of CD
                            ...
                            switch (compareItem6){
                                case 1 -> System.out.println("Return: '" +compareItem6 + "' because the price of DVD is greater than price of CD");
                                case -1 -> System.out.println("Return: '" +compareItem6 + "' because the price of DVD is less than price of CD");
                                default -> System.out.println("Return: '" +compareItem6 + "' because the price of DVD and CD are equal.");
                            }                            
                ...
                case 4: //Register New Member
                    ...
                    switch (numberChosen) {
                        ...
                        case 1: //Register new regular member
                            ...
                            System.out.println("Enter new member method of payment. Enter 'Credit Card', 'Debit Card', or 'Cash'.");
                            String newMethodPayment = scanner.next();
                            newMethodPayment += scanner.nextLine();
                            
                            System.out.println("Enter 'regular' ");
                            String newMembershipType = scanner.nextLine();
                            
                            //Create new member object(Members instance)
                            Members newMember = new Members(newFirstName, newLastName, newTotalSpending,newTotalItemsPurchased, 
                                    newID,newMethodPayment, newMembershipType);

                            //Add new member into ArrayList memberList
                            //memberList.add(new Members(newFirstName, newLastName, newTotalSpending,newTotalItemsPurchased, 
                                    //newID,newMethodPayment, newMembershipType)); 
                            memberList.add(newMember); 
                            System.out.println();
                            System.out.println("New regular member, " +newMember.getFirstNameOfMember()+ " " 
                                    +newMember.getLastNameOfMemeber()+ ", had just been added.");

                            break; //Break from case 1 of switch of case 4
                            
                        case 2: //Register new Premium member

                            System.out.println("Enter new premium member first name ");
                            String newFirstName2 = scanner.next();
                            newFirstName2 += scanner.nextLine();                           
                            
                            System.out.println("Enter new premium member last name ");
                            String newLastName2 = scanner.next();
                            newLastName2 += scanner.nextLine();
                            
                            System.out.println("Enter new premium member total spending ");
                            ...
                            System.out.println("Enter new premium member method of payment. Enter 'Credit Card', "
                                                    + "'Debit Card', or 'Cash'.");
                            String newMethodPayment2 = scanner.next();
                            newMethodPayment2 += scanner.nextLine();
                            
                            System.out.println("Enter 'premium' ");
                            String newMembershipType2 = scanner.nextLine();
                            ...
                            System.out.println("Enter new premium member monthly fee");
                            int monthlyFee = scanner.nextInt();
                            
                            //Create new premium object(a Premium Member instance)
                            PremiumMembers newPremiumMember = new PremiumMembers(newFirstName2, newLastName2, newTotalSpending2,
                                    newTotalItemsPurchased2,newID2, newMethodPayment2, newMembershipType2, hasPremiumMembershp, 
                                    isPaidFeeOnTime, monthlyFee);
                ...
                case 5:  // Restock/Add new products into inventory //Implement restockProduct(int productId, int amount) and inventoryVaule methods
                    ...
                    int numEntered = scanner.nextInt();
                        switch (numEntered) {  //start of second swtich
                            ...
                            System.out.println("The total inventory value is: $" +bookStoreInventoryInstance.inventoryValue());
                            ...
                            case 2: //Add to inventory with item's title, author, and Product ID
                                ...
                                //If user input is 2
                                    ...
                                    System.out.println("The CD titled " +newCds.getNameOfItem()+ " by artist " 
                                            +newCds.getAuthorOfItem()+  " with a Product ID of " +newCds.getProductId()+ 
                                            " and priced at $" +newCds.getPriceOfItem()+" has just been added into the inventory.");
                                ...
                                //If user input is 3
                                    ...
                                    System.out.println();
                                    System.out.println("The DVD titled " +newDvd.getNameOfItem()+ " by author " +newDvd.getAuthorOfItem()+ 
                                            " with a Product ID of " +newDvd.getProductId()+ " and priced at $" + newDvd.getPriceOfItem()+ 
                                            " has just been added into the inventory.");
                                ...
                                //If user enter a different value, this message will occur and will break them from the loop
                                else {
                                    System.out.println("Invalid entry. Exiting to main menu.");
                                    break;
                                }
                ...
                case 6: //Updating Prices
                    ...
                    switch(scanInput){
                        ...
                        case 4: //update all prices of items
                            ...
                            //updates all prices
                            pricingAndPurchaseInstance.updateAllItemsPricing(newBookPrice2, newCDsPrice2, newDVDsPrice2);  
                            System.out.println();
